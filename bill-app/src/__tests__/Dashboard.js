...
describe('Given I am connected as an Admin', () => {
  ...
  describe('When I am on Dashboard page and I click 2 times on edit icon of a card', () => {
    ...
    expect(handleShowTickets2).toHaveBeenCalled()
    expect(screen.getByTestId(`open-billUIUZtnPQvnbFnB0ozvJh`)).toBeTruthy()
    const iconEdit = screen.getByTestId('open-billUIUZtnPQvnbFnB0ozvJh')
    userEvent.click(iconEdit)
    userEvent.click(iconEdit)
    const bigBilledIcon = screen.queryByTestId("big-billed-icon")
    expect(bigBilledIcon).toBeTruthy()
  ...
  expect(handleShowTickets3).toHaveBeenCalled()
  expect(screen.getByTestId(`open-billBeKy5Mo4jkmdfPGYpTxZ`)).toBeTruthy()
  const iconEdit = screen.getByTestId('open-billBeKy5Mo4jkmdfPGYpTxZ')
  userEvent.click(iconEdit)
  userEvent.click(iconEdit)
  const bigBilledIcon = screen.queryByTestId("big-billed-icon")
  expect(bigBilledIcon).toBeTruthy()
  ...
  describe('When I am on Dashboard and there are no bills', () => {
    test('Then, no cards should be shown', () => {
      ...
      const iconEdit2 = screen.queryByTestId('open-billUIUZtnPQvnbFnB0ozvJh')
      expect(iconEdit2).toBeNull()

      const iconEdit3 = screen.queryByTestId('open-billBeKy5Mo4jkmdfPGYpTxZ')
      expect(iconEdit3).toBeNull()
    })
  })
